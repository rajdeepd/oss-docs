...
This tutorial describes  the steps involved in deploying a sample Wordpress application on OpenStack  - Essex using MicroBOSH

####[Install OpenStack - Essex](https://github.com/rajdeepd/oss-docs/blob/master/bosh/documentation/install_openstack.md)
